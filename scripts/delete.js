...
async function getAllSongs() {
    const response = await fetch("https://hammerhead-sequoia-alamosaurus.glitch.me/api/songs/")
    if(response.ok){
...
async function deleteSong() {
    ...
    const response = await fetch("https://hammerhead-sequoia-alamosaurus.glitch.me/api/songs/" + songID, {method: "DELETE"})
